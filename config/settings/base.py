...
)  # (test_project/config/settings/base.py - 3 = test_project/)
...
MIGRATION_MODULES = {"sites": "test_project.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "test_project.utils.context_processors.settings_context",
            ],
        },
    }
]
